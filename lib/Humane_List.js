...
(function() {
  ...
  Humane_List = (function() {
    ...
    Humane_List.prototype.push = function() {
      var args, e, i, last, last_v, num_pos, pos, v, _i, _len, _ref, _results;
      args = arguments;
      pos = args[0];
      num_pos = typeof pos === "number" ? pos : pos === 'top' ? 1 : (last = this.positions().pop(), (last && (last + 1)) || this.d.core.length + 1);
      switch (args.length) {
        case 2:
          e = num_pos ? new Element(num_pos, [], args[1]) : new Element(args[1]);
          break;
        case 3:
          e = num_pos ? new Element(num_pos, args[1], args[2]) : new Element(args[1], args[2]);
          break;
        default:
        ...
        for (i = _i = 0, _len = _ref.length; _i < _len; i = ++_i) {
          ...
          if (v) {
            if (last_v.position() >= v.position()) {
              _results.push(v.update_position(v.position() + 1));
            } else {
