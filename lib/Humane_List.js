...
(function() {
  ...
  Humane_List = (function() {
    ...
    Humane_List.prototype.push = function() {
      var args, e, floor, i, int, next_v, num_pos, pos, v, _i, _len, _ref, _results;
      args = arguments;
      pos = args[0];
      num_pos = (function() {
        if (_.isNumber(pos)) {
          return pos;
        } else if ((pos === 'top' || pos === 'bottom') && this.is_empty()) {
          return 1;
        } else if (pos === 'top') {
          int = parseInt(this.first_position());
          floor = Math.floor(this.first_position());
          ...
          return Math.ceil(this.positions().pop());
        } else {
    ...
    Humane_List.to_hash = function(e) {
      var info;
      if (!e) {
        return null;
      }
    ...
    Humane_List.prototype.describe_position = function(n) {
      var ele;
      ele = _.find(this.d.core, function(e) {
        return e.position() === n;
      });
      return this.constructor.to_hash(ele);
    };

    Humane_List.prototype.describe_object_id = function(oid) {
      var ele;
      ele = _.find(this.d.core, function(e) {
        return e.object_id() === oid;
      });
      return this.constructor.to_hash(ele);
    };
