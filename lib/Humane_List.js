...
(function() {
  ...
  Humane_List = (function() {
    ...
    Humane_List.prototype.downward = function() {
      return this.to(this.position() + 1);
    };

    Humane_List.prototype.upward = function() {
      return this.to(this.position() - 1);
    };

    Humane_List.prototype.forward = Humane_List.prototype.downward;

    Humane_List.prototype.backward = Humane_List.prototype.upward;

    Humane_List.prototype.to = function(n) {
      if (n < 1 && this.length() > 0) {
        throw new Error("Position can't be, " + n + ", because starting position is: 1.");
      }
      if (this.length() === 0) {
        throw new Error("Position can't be, " + n + ", because length is: " + (this.length()) + ".");
      }
      if (n > this.length()) {
        throw new Error("Position can't be, " + n + ", because length is: " + (this.length()) + ".");
      }
    ...
    Humane_List.prototype.to_top = function() {
      if (this.length() > 0) {
        return this.to(1);
      } else {
        return this.to(0);
    ...
    Humane_List.prototype.to_bottom = function() {
      return this.to(this.length());
    };

    Humane_List.prototype.is_at_top = function() {
      return this.position() === 1;
    };

    Humane_List.prototype.is_at_bottom = function() {
      return this.position() === this.length();
    };

    Humane_List.prototype.value = function() {
      return this.at_position(this.position());
    };

    Humane_List.prototype.next = function() {
      return this.at_position(this.position() + 1);
    };

    Humane_List.prototype.previous = function() {
      return this.at_position(this.position() - 1);
    };
    ...
    Humane_List.prototype.push = function() {
      ...
      args = arguments;
      pos = args[0];
      num_pos = typeof pos === "number" ? pos : pos === 'top' ? 1 : (last = this.positions().pop(), (last && (last + 1)) || this.d.core.length + 1);
      switch (args.length) {
        case 2:
      ...
      if (this.length() > 0 && (this.position() === 0 || this.position() === void 0)) {
        this.to(1);
      }
      return e.position();
    };
