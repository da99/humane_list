...
(function() {
  ...
  Humane_List = (function() {
    ...
    Humane_List.prototype.push = function() {
      ...
      switch (args.length) {
        case 2:
          e = new this.Element(args[1]);
          break;
        case 3:
          e = new this.Element(args[1], args[2]);
          break;
        default:
          throw new Error("Invalid arguments: " + arguments);
      }
      if (pos.toString() === 'front') {
    ...
    Humane_List.prototype.merge = function(pos, o) {
      ...
      return this.core = pos.toString() === "front" ? new_core.concat(this.core) : this.core.concat(new_core);
    };
