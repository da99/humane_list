...
(function() {
  ...
  Humane_List = (function() {
    ...
    Humane_List.prototype.pop_top = function() {
      var arr;
      arr = this.core.shift();
      if (!arr) {
        return arr;
    ...
    Humane_List.prototype.pop_end = function() {
      var arr;
      arr = this.core.pop();
      if (!arr) {
        return arr;
    ...
    Humane_List.prototype.insert_top = function(v) {
      return this.core.unshift([[], v]);
    };

    Humane_List.prototype.insert_end = function(v) {
    ...
    Humane_List.prototype.get = function(k) {
