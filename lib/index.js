...
(function() {
  ...
  Humane_List = (function() {
    ...
    Humane_List.prototype.pop = function(pos) {
      var arr;
      arr = pos.toString() === 'left' ? this.core.shift() : this.core.pop();
      if (!arr) {
        return arr;
      }
      return arr.val;
    ...
    Humane_List.prototype.merge = function(pos, o) {
      ...
      return this.core = pos.toString() === "left" ? new_core.concat(this.core) : this.core.concat(new_core);
    };
