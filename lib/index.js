...
(function() {
  ...
  Humane_List = (function() {
    ...
    Humane_List.prototype.to_front = function() {
      if (this.length() > 0) {
        return this.to(1);
      } else {
        return this.to(0);
    ...
    Humane_List.prototype.to_end = function() {
      return this.to(this.length());
    };

    Humane_List.prototype.is_at_front = function() {
      return this.position() === 1;
    };

    Humane_List.prototype.is_at_end = function() {
